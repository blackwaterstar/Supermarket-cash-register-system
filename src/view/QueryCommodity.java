...
//查询学生信息界面
public class QueryCommodity extends JDialog{
	...
	private CommodityModel commodityModel;//模型类
	...
	public QueryCommodity(JFrame owner, String title, boolean modal){
		...
		details_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Details details= new Details(jd, "详细商品信息", true,rowNum,commodityModel);
			}
		});
