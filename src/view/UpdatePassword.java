...
public class UpdatePassword extends JDialog{
	...
	public UpdatePassword(JFrame owner, String title, boolean modal,User user){
		...
		confirm_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(repassword.equals(newpassword)){
					...
					if(achieveOperation.Login(user)){//检查原密码是否正确
						achieveOperation.update_Password(user, newpassword);	//修改密码
