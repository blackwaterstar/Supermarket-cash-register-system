...
public class DeleteCommodity extends JDialog{
	...
	public DeleteCommodity(JFrame owner, String title, boolean modal){
		...
		delete_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String commodity_id = jt.getValueAt(rowNum,0).toString();
				AchieveOperation achieveOperation = new AchieveOperation();
				if(achieveOperation.deleteCommodity(commodity_id)){
